	...
	<h4 class="w3ls-inner-title">     Mediconnect Team</h4>
		<div class="team-w3ls">
			<div class="col-md-6 col-sm-6 col-xs-6 team-grid w3_agileits">
				<img class="col-md-3 img-w3l t1-wthree img-responsive" src="images/hk.png" alt="">
				<div class="col-md-9 team-w3ls-txt">
					<h5>Harshal Kapadia</h5>
					<p>IT Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/harshal.kapadia.7" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
			...
			<div class="col-md-6  col-sm-6 col-xs-6 team-grid w3_agileits">
				...
				<div class="col-md-9 team-w3ls-txt">
					...
					<p>IT Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/harsh.pandya.3914"
			...
			<div class="col-md-6  col-sm-6 col-xs-6 team-grid w3_agileits t2">
				<img class="col-md-3 img-w3l t1-wthree img-responsive" src="images/jj.jpg" alt="">
				<div class="col-md-9 team-w3ls-txt">
					<h5>Jeel Sukhadiya</h5>
					<p>IT Engineer , D.J. Sanghvi College</p>
					<ul class="agileits_social_icons">
						<li><a href="https://www.facebook.com/jeel.sukhadiya" class="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
						<li><a href="#" class="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
						<li><a href="#" class="google"><i class="fa fa-google-plus" aria-hidden="true"></i></a></li>
					</ul>
				</div>	
